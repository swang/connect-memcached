...
module.exports = function(connect){
  ...
  MemcachedStore.prototype.gets = function(sid, fn) {
      sid = this.getKey(sid);

      this.client.gets(sid, function(err, data) {
          try {
              if (!data) {
                 return fn();
              }
  ...
  MemcachedStore.prototype.set = function(sid, sess, fn) {
      ...
      try {
          ...
          this.client.gets(sid, sess, ttl, function(err, data) {
            this.client.cas(sid, sess, data.cas, ttl, function() {
  ...
  MemcachedStore.prototype.cas = function(sid, sess, cas, fn) {
      sid = this.getKey(sid);
      ...
      try {
          ...
          this.client.cas(sid, sess, cas, ttl, function() {
              fn && fn.apply(this, arguments);
          });
      } catch (err) {
          fn && fn(err);
